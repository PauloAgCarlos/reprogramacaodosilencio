  ...
  @endif
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">Registar Novo Condutor</h3>
            </div>
            <div class="block-content">
              <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                  <form action="/salvar_condutor" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4 col-5 inline-block">
                      ...
                      <input type="number" class="form-control" id="dm-ecom-product-name" required name="telefone" value="">
                    </div>                      
                    <div class="mb-4 col-5 inline-block">
                      <label class="form-label" for="dm-ecom-product-name">Foto</label>
                      <input type="file" class="form-control" id="dm-ecom-product-name" required name="foto" value="">
                    </div>          
