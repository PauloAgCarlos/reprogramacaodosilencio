  ...
  @endif
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">Registar Usuarios</h3>
            </div>
                ...
                <div class="col-md-12 col-lg-10">
                  <form action="/salvar_usuario" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 col-5 inline-block">
                      ...
                      <input type="text" class="form-control" id="dm-ecom-product-name" required name="name" value="">
                    </div>
                    <div class="mb-4 col-5 inline-block">
                    ...
                    <div class="mb-4 col-5 inline-block">
                      ...
                      <input type="password" class="form-control" id="dm-ecom-product-name" required name="password" value="">
                    </div>
                    <div class="mb-4 col-5 inline-block">
                      <label class="form-label" for="dm-ecom-product-name">Confirmar Senha</label>
                      <input type="password" class="form-control" id="dm-ecom-product-name" required name="password_confirmation" value="">
                    </div>
